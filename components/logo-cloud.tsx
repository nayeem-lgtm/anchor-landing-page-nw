...
export function LogoCloud() {
  return (
    <section className="py-16 border-t border-[var(--color-baltic-sea-900)]" aria-label="Trusted marketing partners">
      <div className="mx-auto max-w-[1400px] px-2.5 sm:px-6 lg:px-12">
        <p className="text-center text-sm text-[var(--color-baltic-sea-500)] mb-10">
          Trusted by Marketing Partners Worldwide
        </p>
      </div>
